...
export interface BlockTextBuilder {
  ...
  closeBlock(opts?: { trailingLineBreaks?: number; blockTransform?: (str: string) => string }): void;
  ...
  openListItem(opts?: { prefix?: string }): void;
  closeListItem(): void;
  closeList(opts?: { trailingLineBreaks?: number }): void;

  openTable(): void;
  openTableRow(): void;
  openTableCell(opts?: { maxColumnWidth?: number }): void;
  closeTableCell(opts?: { colspan?: number; rowspan?: number }): void;
  closeTableRow(): void;
  closeTable(opts: { tableToString: TablePrinter; leadingLineBreaks?: number; trailingLineBreaks?: number }): void;
}
...
export interface Options {
  ...
  returnDomByDefault?: boolean;
  tags?: Record<string, Partial<Omit<SelectorDefinition, 'selector'>> & { selector?: string }>;
